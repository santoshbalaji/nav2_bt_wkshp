...
: LifecycleNode("behavior_server", "", options),
  ...
  default_ids_{"spin", "backup", "drive_on_heading", "wait", "feature_detection","aruco_detection","aruco_tracking"},
  default_types_{"nav2_behaviors/Spin",
    "nav2_behaviors/BackUp",
    "nav2_behaviors/DriveOnHeading",
    "nav2_behaviors/Wait",
    "nav2_behaviors/FeatureDetection",
    "nav2_behaviors/ArucoDetection",
    "nav2_behaviors/ArucoTracking"}
{
  declare_parameter(
    "costmap_topic",
