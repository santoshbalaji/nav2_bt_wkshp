...
#ifndef NAV2_BT_NAVIGATOR__NAVIGATORS__AUTO_DOCKING_HPP_
#define NAV2_BT_NAVIGATOR__NAVIGATORS__AUTO_DOCKING_HPP_
...
#include "nav2_msgs/msg/auto_docking.hpp"
#include "nav2_msgs/action/auto_docking.hpp"
 ...
 * @brief A navigator for performing auto docking based on features
 */
class AutoDockingNavigator
  : public nav2_bt_navigator::Navigator<nav2_msgs::action::AutoDocking>
{
public:
  using ActionT = nav2_msgs::action::AutoDocking;
  ...
  /**
   * @brief A subscription and callback to handle the topic-based docking request
   * @param pose Pose received via atopic
   */
  void onDockReceived(const nav2_msgs::msg::AutoDocking::SharedPtr auto_dock);

  /**
   * @brief Get action name for this navigator
   * @return string Name of action server
   */
  std::string getName() {return std::string("auto_docking");}
...
protected:
  ...
  rclcpp::Subscription<nav2_msgs::msg::AutoDocking>::SharedPtr auto_docking_sub_;
...
#endif  // NAV2_BT_NAVIGATOR__NAVIGATORS__AUTO_DOCKING_HPP_
